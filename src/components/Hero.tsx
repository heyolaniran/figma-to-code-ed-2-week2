    ...
    <section className="container mt-8 w-full">
      <div className="rounded-2xl  text-white hero">
        ...
        <div className="mt-12 flex justify-center items-center gap-2">
          <Link
            href={"/"}
            className="bg-white rounded-2xl px-4 py-2 text-black text-sm font-semibold"
          >
            Start shopping
          </Link>
          ...
          <Link
            href={"/"}
            className=" rounded-full w-10 h-10 bg-white flex items-center text-center justify-center"
          >
            <Image
              src={"/arrow.svg"}
