...
export default function ShoppingPaymentMethod({item} : {item : ShoppingPaymentMethodProps}) {

    return (
       <div>
        <input type="radio" id="hosting-mail" name="hosting" value="" className="hidden peer" required />
