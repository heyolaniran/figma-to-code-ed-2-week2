          ...
          <table className="w-full text-sm text-left  text-gray-500 ">
            ...
            <tbody>
              {products?.map((product, index) => (
                <tr
                  className="bg-white border-slate-300 border-b mb-2"
                  key={index}
                >
                  <th
                    scope="row"
                    ...
                    <div className="flex  items-start">
                      <div className="grid grid-cols-2 gap-2">
                        ...
                        <div className="  col-span-1">
                          ...
                          <span className="text-md font-bold text-black mt-1"></span>
                        </div>
                      </div>
                    </div>
                  </th>
          ...
          <div className="border border-slate-200 rounded-xl p-4">
            ...
            <div className="flex justify-between mt-4">
              ...
              <p className="flex items-center gap-1 text-sm">
                <span className="text-xs">{subTotalAmount?.currencyCode}</span>
            ...
            <div className="flex justify-between mt-2">
              ...
              <p className="flex items-center font-bold text-sm">
                <span className="text-xs">{totalAmount?.currencyCode}</span>
                {totalAmount?.amount}
              </p>
            </div>
