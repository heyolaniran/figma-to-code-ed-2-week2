    ...
    <div className="container mb-4">
      ...
      <div className="grid xl:grid-cols-2 grid-cols-1  gap-12">
        <div className="">
          ...
          <small className="text-xs text-gray-400"> <span className="font-semibold text-black">New customer ? <Link href={''} className=" underline">Signup </Link> </span> to get better offer </small>
